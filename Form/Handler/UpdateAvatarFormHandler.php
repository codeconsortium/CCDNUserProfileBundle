...
class UpdateAvatarFormHandler
{
	 ...
	 * 
	 * @access protected
	 * @var \CCDNUser\ProfileBundle\Form\Type\AvatarFornType $form 
	 */
    protected $form;
     ...
     */
    public function __construct(FormFactory $factory, $avatarFormType, BaseManagerInterface $manager)
    {
    ...
    {
        if (null == $this->form) {
			$this->form = $this->factory->create($this->avatarFormType, $this->profile);
        }
