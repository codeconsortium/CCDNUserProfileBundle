 ...
 *
 */
class UpdateContactFormHandler
{
    /**
     *
     * @access protected
     ...
     *
     * @access protected
     * @var \CCDNUser\ProfileBundle\Form\Type\ContactFornType $form
     */
    protected $form;
     ...
     */
    public function __construct(FormFactory $factory, $contactFormType, BaseManagerInterface $manager)
    {
    ...
    {
        if (null == $this->form) {
            $this->form = $this->factory->create($this->contactFormType, $this->profile);
        }
