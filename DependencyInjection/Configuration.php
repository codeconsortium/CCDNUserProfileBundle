                ...
                ->arrayNode('model')
                    ...
                    ->children()
                        ->arrayNode('user')
                            ...
                            ->canBeUnset()
                            ->children()
                                ->scalarNode('class')->defaultValue('CCDNUser\ProfileBundle\Model\FrontModel\UserModel')->end()
                            ->end()
                        ->end()
                        ->arrayNode('profile')
                            ->addDefaultsIfNotSet()
                            ->canBeUnset()
                            ->children()
                                ->scalarNode('class')->defaultValue('CCDNUser\ProfileBundle\Model\FrontModel\ProfileModel')->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()
                ...
                ->arrayNode('gateway')
                    ...
                    ->children()
                        ->arrayNode('user')
                            ...
                            ->canBeUnset()
                            ->children()
                                ->scalarNode('class')->defaultValue('CCDNUser\ProfileBundle\Model\Component\Gateway\UserGateway')->end()
                            ->end()
                        ->end()
                        ->arrayNode('profile')
                            ->addDefaultsIfNotSet()
                            ->canBeUnset()
                            ->children()
                                ->scalarNode('class')->defaultValue('CCDNUser\ProfileBundle\Model\Component\Gateway\ProfileGateway')->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()
                ...
                ->arrayNode('repository')
                    ...
                    ->children()
                        ->arrayNode('user')
                            ...
                            ->canBeUnset()
                            ->children()
                                ->scalarNode('class')->defaultValue('CCDNUser\ProfileBundle\Model\Component\Repository\UserRepository')->end()
                            ->end()
                        ->end()
                        ->arrayNode('profile')
                            ->addDefaultsIfNotSet()
                            ->canBeUnset()
                            ->children()
                                ->scalarNode('class')->defaultValue('CCDNUser\ProfileBundle\Model\Component\Repository\ProfileRepository')->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()
                ...
                ->arrayNode('manager')
                    ...
                    ->children()
                        ->arrayNode('user')
                            ...
                            ->canBeUnset()
                            ->children()
                                ->scalarNode('class')->defaultValue('CCDNUser\ProfileBundle\Model\Component\Manager\UserManager')->end()
                            ->end()
                        ->end()
                        ->arrayNode('profile')
                            ->addDefaultsIfNotSet()
                            ->canBeUnset()
                            ->children()
                                ->scalarNode('class')->defaultValue('CCDNUser\ProfileBundle\Model\Component\Manager\ProfileManager')->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()
